...
async function getFbUpdates(req, res) {
  try {
    return res
      .status(200)
      .send("<pre>" + JSON.stringify(fbUpdates, null, 2) + "</pre>");
  } catch (error) {
    console.log("Error in getFbUpdates: " + error);
...
module.exports = { getFbWebhook, postFbWebhook, getFbUpdates };
